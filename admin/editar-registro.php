                      ...
                      <form class="editar-registrado" role="form" name ="guardar_registro" id="guardar_registro" method="post" action="modelo-registrado.php">
                          <div class="box-body">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" value="<?php echo $registrado['email_registrado'];?>" class="form-control" id="email" name="email" placeholder="Email">
                            </div>
                            <?php
                                      ...
                                      <li class="col-md-4 ">
                                        <div class="tabla-precio text-center">
                                          ...
                                          <div class="orden">
                                            ...
                                            <input type="number" value="<?php echo $boletos['un_dia'];?>" class="form-control" min="0" id="pase_dia" size="3" name="boletos[un_dia][cantidad]" placeholder="0">
                                      ...
                                      <li class="col-md-4">
                                          <div class="tabla-precio text-center">
                                            ...
                                            <div class="orden">
                                                ...
                                                <input type="number" value="<?php echo $boletos['pase_completo'];?>" class="form-control" min="0" id="pase_completo" size="3" name="boletos[completo][cantidad]" placeholder="0">
                                      ...
                                      <li class="col-md-4">
                                            <div class="tabla-precio text-center">
                                              ...
                                              <div class="orden">
                                                  ...
                                                  <input type="number" value="<?php echo $boletos['pase_2dias'];?>" class="form-control" min="0" id="pase_dosdias" size="3" name="boletos[2dias][cantidad]" placeholder="0">
                ...
                <div class="caja clearfix row ">
                  <div class="extras col-md-6">
                    <div class="orden">
                      ...
                      <input type="number" value="<?php echo $boletos['camisas']; ?>" class="form-control" min="0" id="camisa_evento" size="3" name="pedido_extra[camisas][cantidad]" placeholder="0">
                      <input type="hidden" value="10" name="pedido_extra[camisas][precio]">
                    </div><!--orden-->
                    <div class="orden">
                        <label for="etiquetas">Paquete de 10 etiquetas $2 <small>(HTML5,CSS, JavaScript, Chrome)</small></label>
                        <input type="number" value="<?php echo $boletos['etiquetas']; ?>" class="form-control" min="0" id="etiquetas" size="3" name="pedido_extra[etiquetas][cantidad]" placeholder="0">
